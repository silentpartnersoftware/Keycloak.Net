            ...
            string componentId = null, string connectionTimeout = null, string connectionUrl = null, string useTruststoreSpi = null, CancellationToken cancellationToken = default)
        {
            var response = await GetBaseUrl(realm)
                ...
                .PostMultipartAsync(content => content
                    ...
                    .AddString(nameof(useTruststoreSpi), useTruststoreSpi), cancellationToken: cancellationToken)
                .ConfigureAwait(false);
            return response.ResponseMessage.IsSuccessStatusCode;
        }
        ...
        public async Task<Response<bool>> CreateOrUpdateRealmLocalizationTexts(string realm, string locale, IDictionary<string, string> localizationTexts, CancellationToken cancellationToken = default)
        {
            try
            {
                var response = await GetBaseUrl(realm)
                    ...
                    .PostJsonAsync(localizationTexts, cancellationToken: cancellationToken)
                    .ConfigureAwait(false);
